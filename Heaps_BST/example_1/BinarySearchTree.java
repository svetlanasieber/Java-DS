...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public void insert(E element) {
        if (this.root == null) {
            ...
            insertIntoo(this.root, element);
        }
    }

    private void insertIntoo(Node<E> node, E element) {
        if (isGreater(element, node)) {
            if (node.getRight() == null) {
                node.rightChild = new Node<>(element);
            } else {
                insertIntoo(node.getRight(), element);
            }
            ...
            if (node.getLeft() == null) {
                ...
                insertIntoo(node.getLeft(), element);
            }
        }
...
//        return containsNode(this.root, element) != null;
    ...
    public void deleteMax() {
        ...
        current.count--;
        current.rightChild = current.rightChild.getLeft();
    }
